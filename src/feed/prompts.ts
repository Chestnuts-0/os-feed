...
- "reason_cn": 简要介绍，必须 110-130 个汉字（硬性要求：少于 100 字或多于 150 字都不合格，约 3 行，写完后数一遍字数确认），一段连贯的文字。要求：比 summary_cn 更具体，可以出现专业术语和技术概念，但读者仍能在较短篇幅内看懂项目更细节的内容。不要用①②③等序号编号。不要重复 summary_cn 的内容。
